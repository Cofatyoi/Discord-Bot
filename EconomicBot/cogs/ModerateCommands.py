...
class ModerateCommands(commands.Cog):
    ...
    @commands.slash_command(
        name="clear",
        description="Админ комманда. Очищает сообщения"
    )
    ...
    @commands.slash_command(
        name="ban",
        description="Админ комманда. Удаляет игрока из сервера без возможности зайти обратно"
    )
    ...
    @commands.slash_command(
        name="unban",
        description="Розбанивает игрока на сервере"
    )
    ...
    @commands.slash_command(
        name="kick",
        description="Кикает игрока из сервера"
    )
    ...
    @commands.slash_command(
        name="mute",
        description="Запрещает участнику говорить"
    )
